...
//
// The issuer/options parameters are part of the SigningService contract for
// the remote-mode client but are unused in the inprocess implementation,
// which signs synchronously without UCAN authorization.
